class ZodiacsController < ApplicationController
  ...
  def sign
    this_zodiac = Zodiac.find_by({ :sign => params["the_sign"]})
    @prediction = this_zodiac.fortune
    render 'sign'
  end

  def creature
    this_zodiac = Zodiac.find_by({ :creature => params["the_creature"]})
    @sign = this_zodiac.sign
    @prediction = this_zodiac.fortune
    render 'creature'
  end
end
